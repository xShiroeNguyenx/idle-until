// CommonJS type declarations (matches the "require" condition).
// `require("idle-until")` returns the function directly.

declare function idleUntil(fn: () => void): idleUntil.IdleUntilController;

declare namespace idleUntil {
  interface IdleUntilController {
